...
export const POST = async (req: Request) => {
    try {
        ...
        if (!idToAdd) {
            return new Response('This person doesnot exist.', { status: 400 })
        }
        ...
        // check if the user is already added as friend
        ...
        // check if the user and the user to add are already friends
        ...
        return new Response('Invalid Request: [ADD_FRIEND]', { status: 500 })
    }
}