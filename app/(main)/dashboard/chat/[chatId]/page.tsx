...
const ChatPage: FC<ChatPageProps> = async ({ params }) => {
    ...
    return <div className="flex-1 justify-between flex flex-col h-full max-h-[calc(100vh - 6rem)] ">
        <div className="flex sm:items-center justify-between py-3 border-b-2 border-gray-100">
            <div className="relative flex items-center space-x-4">
                ...
                <div className="flex flex-col leading-tight">
                    ...
                    <span className="text-sm text-gray-500 text-muted-foreground">{chatPartner.email}</span>
                </div>
            </div>
        </div>
